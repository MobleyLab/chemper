...
graph_data = [
    ...
    (make_cluster_graph(['CC', 'CCC'], layers=1),
     ...
     "[*H2,*H3;#6;!r;+0;A;X4;x0:1](-;!@[#1H0X1,#6H3X4;!r;+0;A;x0])(-;!@[#1AH0X1x0!r+0])(-;!@[#1AH0X1x0!r+0])"\
     "-;!@[#6AH3X4x0!r+0:2](-;!@[#1AH0X1x0!r+0])(-;!@[#1AH0X1x0!r+0])-;!@[#1AH0X1x0!r+0]"
     ),
    # 9
    (make_cluster_graph(['C1CCCC1', 'C1=CNC=C1', 'CO'], layers=2),
     ...
     "(-,:;@[*AH2X4,*H1X3a;#6;+0;r5;x2](-;!@[#1AH0X1x0!r+0])(-;!@[#1AH0X1x0!r+0])-,:;@"\
     "[*AH2X4,*H1X3a;#6;+0;r5;x2])-,:[*!rAH3X4x0,*AH2X4r5x2,*H1X3ar5x2;#6;+0:2](-,:"\
