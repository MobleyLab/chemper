 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "* triple\n",
    "\n",
    "This is done with the utility function `create_dictionaries_for_clusters` which creates a list of dictionaries for each molecule by label in the form:\n",
    "` [ ('name', [list of dictionaries for each molecule]) ] `.\n",
    "\n",
    "These dictionaries are of the form `{smirks index: atom index}`. In a bond we have two indexed atoms in a SMIRKS (1 and 2) because you need two atoms in order to identify a bond. For example, in the first molecule above, there is a single bond between atoms 0 and 1. The dictionary to specify that bond would have the form `{1:0, 2:1}`. There is a list of dictionaries for each molecule associated with each label.\n",
    "\n",
    ...
    "Only molecules 1 and 2 have aromatic bonds. The bonds in these molecules are specified by dictionaries showing the SMIRKS index and atom index for each of the aromatic bonds below.\n",
    "The other four molecules have zero aromatic bonds so the list of dictionaries are empty as no bonds need to be specified.\n",
    "\n",
    "\n",
    "### Moving forward\n",
    "\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "   {1: 2, 2: 3},\n",
       "   {1: 3, 2: 4}],\n",
       "  [{1: 1, 2: 2}, {1: 0, 2: 1}, {1: 0, 2: 4}, {1: 2, 2: 3}, {1: 3, 2: 4}],\n",
       "  [],\n",
       "  [],\n",
       "  []])"
      ]
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[#6!rAH1X3x0,#6!rAH2X4x0,#6!rAH3X4x0,#6AH1X3r6x2,#6AH2X4r6x2,#6H1X3ar5x2,#6H1X3ar6x2,#7H1X3ar5x2,#8!rAH0X2x0;+0:1]-[#1!rH0X1x0,#6!rH1X3x0,#6!rH2X4x0,#6!rH3X4x0,#6H1X3r6x2,#6H2X4r6x2,#8!rH0X2x0;+0;A:2]  -->  [#1H0X1x0,#6H1X3x0,#6H2X4x0,#6H3X4x0,#6H1X3r6x2,#6H2r6x2X4,#8H0x0X2;+0;A:2]-[#6H1AX3x0,#6AH2X4x0,#6AH3X4x0,#6AH2r6x2X4,#6H1X3x2ar5,#6H1X3r6x2a,#7H1X3x2ar5,#8Ax0H0X2,#6H1Ar6X3;+0:1]\n",
      "Rejected!\n",
      " proposed SMIRKS changed the way fragments are clustered\n",
      "------------------------------------------------------------------------------------------\n",
      "Iteration:  1\n",
      "Attempting to change SMIRKS #0\n",
      "[#6!rAH1X3x0,#6!rAH2X4x0,#6!rAH3X4x0,#6AH1X3r6x2,#6AH2X4r6x2,#6H1X3ar5x2,#6H1X3ar6x2,#7H1X3ar5x2,#8!rAH0X2x0;+0:1]-[#1!rH0X1x0,#6!rH1X3x0,#6!rH2X4x0,#6!rH3X4x0,#6H1X3r6x2,#6H2X4r6x2,#8!rH0X2x0;+0;A:2]  -->  [#6H1AX3x0,#6AH2X4x0,#6AH3X4x0,#6H1Ar6x2X3,#6AH2r6x2X4,#6H1X3x2ar5,#6H1X3r6x2a,#7H1X3x2ar5,#8X2Ax0H0;+0:1]-[#1H0X1x0,#6H1X3x0,#6H3X4x0,#6H1X3r6x2,#6H2r6x2X4,#8X2H0x0,#6X4x0;+0;A:2]\n",
      "Rejected!\n",
      " proposed SMIRKS changed the way fragments are clustered\n",
      "------------------------------------------------------------------------------------------\n",
      "Iteration:  2\n",
      "Attempting to change SMIRKS #1\n",
      "[#6r5,#6r6,#7r5;+0;H1;X3;a;x2:1]:;@[#6r5,#6r6,#7r5;+0;H1;X3;a;x2:2]  -->  [#6r5,#6r6,#7r5;+0;H1;X3;a;x2:2]:;@[#6r5,#6r6,#7;+0;H1;X3;a;x2:1]\n",
      "Creating graph matching current types with reference types...\n",
      "\n",
      "Graph creation took 0.000 s\n",
      "\n",
      ...
      "Iteration:  3\n",
      "Attempting to change SMIRKS #0\n",
      "[#6!rAH1X3x0,#6!rAH2X4x0,#6!rAH3X4x0,#6AH1X3r6x2,#6AH2X4r6x2,#6H1X3ar5x2,#6H1X3ar6x2,#7H1X3ar5x2,#8!rAH0X2x0;+0:1]-[#1!rH0X1x0,#6!rH1X3x0,#6!rH2X4x0,#6!rH3X4x0,#6H1X3r6x2,#6H2X4r6x2,#8!rH0X2x0;+0;A:2]  -->  [#6H1AX3x0,#6AH2X4x0,#6AH3X4x0,#6H1Ar6x2X3,#6AH2r6x2X4,#6H1X3x2ar5,#6H1X3r6x2a,#7H1X3x2ar5,#8X2Ax0H0;+0:1]-[#1H0X1x0,#6H1X3x0,#6H2X4x0,#6H3X4x0,#6H1X3r6x2,#6H2r6x2X4,#8H0x0X2;A:2]\n",
      "Rejected!\n",
      " proposed SMIRKS changed the way fragments are clustered\n",
      "------------------------------------------------------------------------------------------\n",
      "Iteration:  4\n",
      "Attempting to change SMIRKS #1\n",
      "[#6r5,#6r6,#7r5;+0;H1;X3;a;x2:2]:;@[#6r5,#6r6,#7;+0;H1;X3;a;x2:1]  -->  [#6r6,#7,#6;+0;H1;X3;a;x2:1]:;@[#6r5,#6r6,#7r5;+0;H1;X3;a;x2:2]\n",
      "Creating graph matching current types with reference types...\n",
      "\n",
      "Graph creation took 0.000 s\n",
      "\n",
      ...
      "[*!rx0,*r6x2;#6;+0;A;H1;X3:1]=[#6!rH1X3x0,#6H1X3r6x2,#8!rH0X1x0;+0;A:2]  -->  [#6H1X3r6x2,#8H0X1x0,#6H1x0;+0;A:2]=[*x0,*r6x2;#6;+0;A;H1;X3:1]\n",
      "Creating graph matching current types with reference types...\n",
      "\n",
      "Graph creation took 0.000 s\n",
      "\n",
      ...
      "Iteration:  7\n",
      "Attempting to change SMIRKS #0\n",
      "[#6!rAH1X3x0,#6!rAH2X4x0,#6!rAH3X4x0,#6AH1X3r6x2,#6AH2X4r6x2,#6H1X3ar5x2,#6H1X3ar6x2,#7H1X3ar5x2,#8!rAH0X2x0;+0:1]-[#1!rH0X1x0,#6!rH1X3x0,#6!rH2X4x0,#6!rH3X4x0,#6H1X3r6x2,#6H2X4r6x2,#8!rH0X2x0;+0;A:2]  -->  [#1H0X1x0,#6H1X3x0,#6H2X4x0,#6H3X4x0,#6H1X3r6x2,#6H2r6x2X4,#8H0x0X2;+0;A:2]-[#6H1AX3x0,#6AH2X4x0,#6AH3X4x0,#6H1Ar6x2X3,#6AH2r6x2X4,#6H1X3x2ar5,#6H1X3r6x2a,#7H1X3x2ar5,#8X2Ax0H0:1]\n",
      "Rejected!\n",
      " proposed SMIRKS changed the way fragments are clustered\n",
      "------------------------------------------------------------------------------------------\n",
      "Iteration:  8\n",
      "Attempting to change SMIRKS #1\n",
      "[#6r6,#7,#6;+0;H1;X3;a;x2:1]:;@[#6r5,#6r6,#7r5;+0;H1;X3;a;x2:2]  -->  [#6r6,#7,#6;+0;H1;X3;a;x2:1]:;@[#6r5,#6r6,#7;+0;H1;X3;a;x2:2]\n",
      "Creating graph matching current types with reference types...\n",
      "\n",
      "Graph creation took 0.000 s\n",
      "\n",
      ...
      " zz_sing              | [#6!rAH1X3x0,#6!rAH2X4x0,#6!rAH3X4x0,#6AH1X3r6x2,#6AH2X4r6x2,#6H1X3ar5x2,#6H1X3ar6x2,#7H1X3ar5x2,#8!rAH0X2x0;+0:1]-[#1!rH0X1x0,#6!rH1X3x0,#6!rH2X4x0,#6!rH3X4x0,#6H1X3r6x2,#6H2X4r6x2,#8!rH0X2x0;+0;A:2] \n",
      "--------------------------------------------------------------------------------\n",
      " zz_aromatic          | [#6r6,#7,#6;+0;H1;X3;a;x2:1]:;@[#6r5,#6r6,#7;+0;H1;X3;a;x2:2] \n",
      "--------------------------------------------------------------------------------\n",
      " zz_double            | [#6H1X3r6x2,#8H0X1x0,#6H1x0;+0;A:2]=[*x0,*r6x2;#6;+0;A;H1;X3:1] \n",
      "--------------------------------------------------------------------------------\n",
      "\n"
     ]
    }
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "Now we will continue trying to reduce the SMIRKS. Note, in this case we set verbose to False and just print the final SMIRKS since 2,000 is a lot of steps. "
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "smirks2k = bond_smirksifier.reduce(max_its=2000, verbose=False)\n",
    "bond_smirksifier.print_smirks(smirks2k)"
   ]
  },
  {
   "cell_type": "markdown",
