...
e.g. `chemper-0.1.2`, otherwise it will be appended with `+X` where `X` is the number of commits 
ahead from the last tag, and then `-YYYYYY` where the `Y`'s are replaced with the `git` commit hash.

**Source**
This README was created automatically from the [MolSSI CookieCutter](https://github.com/MolSSI/cookiecutter-cms).
